...
const Navbar = () => {
  ...
  return (
    <div className="h-[3.75rem]  flex items-center justify-between">
      ...
      <ul className="flex items-center justify-between gap-x-[2.5rem] md:gap-x-[1rem] text-lg lg:text-[1.1rem] md:text-[0.8rem]  leading-5 font-[400] sm:hidden sm:flex-col sm:top-32 sm:left-2 sm:items-start  sm:gap-y-2 sm:opacity-60 cursor-pointer">
        <li className="">
